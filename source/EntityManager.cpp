...
void EntityManager::AddEntity( IBase* pObject, unsigned int bucket )
{
	// Validate the parameter
	assert(pObject != nullptr && "EntityManager::AddEntity - parameter cannot be null");
	...
	m_tEntities[bucket].push_back(pObject);
...
void EntityManager::RemoveEntity(IBase* pObject, unsigned int bucket)
{
	// Validate the iteration state
	assert( m_bIterating == false && "EntityManager::RemoveEntity - cannot remove while iterating" );

	// Validate the parameters
	assert(pObject != nullptr && "EntityManager::RemoveEntity - cannot remove NULL");
...
void EntityManager::RemoveEntity(IBase* pObject)
{
	// Validate the iteration state
	assert( m_bIterating == false && "EntityManager::RemoveEntity - cannot remove while iterating" );

	// Validate the parameters
	assert(pObject != nullptr && "EntityManager::RemoveEntity - pointer cannot be null");
